...
# Step 1: Load dataset
df = pd.read_csv('C:/Users/raval/fraud_detection/data/fraud_70_nonfraud_30.csv')
...
# Step 6: Define the Random Forest model pipeline
...
joblib.dump(rf_pipeline, 'random_forest_fraud_model.pkl')
...
plt.legend()
plt.savefig('rf_metrics_comparison.png')
plt.show()
...
plt.savefig('rf_computational_overhead.png')
plt.show()
